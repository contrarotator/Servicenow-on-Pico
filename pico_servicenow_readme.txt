...
Connect it to the computer and IDE of your choice ( I used a Mac running Thonny. )
...
Save and run.
If all goes well, there wil be no error message and on the Pico the LED will light
...
idenify teh incident by number
open the incident and resolve it.  You will need to enter a work note.
Admire your Pico W.
